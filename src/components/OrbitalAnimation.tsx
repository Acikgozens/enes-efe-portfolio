...
export default function OrbitalAnimation() {
    ...
    if (!hasMounted) return <div className="w-64 h-64 md:w-80 md:h-80 lg:w-[400px] lg:h-[400px] rounded-full border border-dashed border-[#222]" />;

    return (
        <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[400px] lg:h-[400px] flex items-center justify-center">

            {/* Center Core */}
            <div className="absolute w-3 h-3 bg-accent/80 rounded-full z-10 shadow-[0_0_15px_rgba(253,184,19,0.8)]"></div>

            {/* --- Orbit 1: Inner (JavaScript) --- */}
            <div className="absolute w-[50%] h-[50%] border-[2px] border-dashed border-[#222] rounded-full"></div>
            <motion.div
            ...
            {/* --- Orbit 2: Middle (C#) --- */}
            <div className="absolute w-[75%] h-[75%] border border-[#333] rounded-full"></div>
            <motion.div
                animate={{ rotate: [0, -360] }}
            ...
            <div className="absolute w-[100%] h-[100%] border border-[#222] rounded-full"></div>
            <motion.div
                animate={{ rotate: [0, 360] }}
